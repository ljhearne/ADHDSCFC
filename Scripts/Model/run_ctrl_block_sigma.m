...
for that_seed = 1:length(seeds)
    ...
    [SH, SP] = meshgrid(min_sigma_h:min_sigma_step_h:max_sigma_h, min_sigma_p:min_sigma_step_p:max_sigma_p);
    ...
    for kk=1:numel(SH)
        ...
        [aCTRL_FC_HUBS, c_best, c_critic, corr_max, c_range, correl, hubs_std_values(:, kk)] = perform_pse_subjects(SC, FCPCC, sigma_noise, HBN, mu_b);
