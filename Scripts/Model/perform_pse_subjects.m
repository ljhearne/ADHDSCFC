function [aFCPCC, c_best, c_critic, corr_max, c_range, correl, std_sigmas] = perform_pse_subjects(SC, FCPCC, sigma_noise, HBN)
...
% to detect the optimal c-value across subjects
    ...
    parfor subject_idx = 1:size(SC, 3)
        ...
        [Sigma(:, :, subject_idx), std_sigmas(subject_idx)] = introduce_node_based_variability(sigma_noise, node_attributes(subject_idx, :));
